...
def main():
    ...
    (ok if "private to each student" in cbtsrc else fail)("cbt.js: honest privacy note (Cloud Sync data never aggregated)")
    ...
    (ok if "<h2>\U0001f3eb Live CBT Hall</h2>" in cbtsrc and "<h2>\U0001f393 Teacher console</h2>" in cbtsrc else fail)("cbt.js: view-root headings promoted to h2 (hall + console)")
