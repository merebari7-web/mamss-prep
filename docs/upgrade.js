...
(function () {
  ...
  function whatsNew() {
    ...
    var items = [
      ...
      ["\U0001f525", "The Habit Loop", "MAMSS PREP now fights for your days, not just your syllabus. The overview opens on a Today board: your streak in flames with banked streak shields (every seven-day run earns a freeze that silently bridges one missed day), three daily quests and a weekly quest with coin rewards that claim themselves the moment you earn them, and a weekly class league computed from the school's own progress reports — first names only, effort-based, and calm about it until the class files its first report. Quest clears, streak milestones and podium finishes get a designed celebration in ink-green and gold — and none of it animates at you if you prefer reduced motion. The engine's own maths still runs the badges; this layer only makes the loop visible, kind and hard to put down."],
